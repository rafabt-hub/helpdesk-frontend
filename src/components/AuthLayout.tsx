...
export function AuthLayout() {
  return (
    <div className="w-screen h-screen bg-cover bg-center flex overflow-hidden" style={{ backgroundImage: `url(${bgImage})` }}>
      ...
      <main className="w-full lg:w-1/2 mt-10 h-full bg-white flex flex-col px-8 py-10 items-center lg:px-20 lg:py-16 rounded-t-[2rem] lg:rounded-tr-none lg:rounded-bl-[2rem] shadow-2xl">
        <div className="flex items-center justify-center gap-4 mb-10 lg:gap-8 lg:mt-20">
