...
export function AuthLayout() {
  return (
    <div className="w-screen h-screen bg-cover bg-center flex overflow-hidden" style={{ backgroundImage: `url(${bgImage})` }}>
      ...
      <main className="w-full lg:w-1/2 mt-2 h-full bg-white flex flex-col items-center rounded-t-[2rem] lg:rounded-tr-none shadow-2xl   overflow-y-auto md:overflow-y-hidden">
        <div className="flex items-center justify-center gap-4 mb-4 mt-5">
          <img src={logoSvg} alt="Logo" className="w-14 h-14" />
          <h1 className="text-2xl text-blue-800 font-bold">HelpDesk</h1>
        </div>
