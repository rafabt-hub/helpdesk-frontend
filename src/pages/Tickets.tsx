    ...
    <>
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        <div className="p-4 lg:p-6 border-b lg:border-none">
          <h2 className="text-xl lg:text-2xl font-bold text-blue-500">Chamados</h2>
        </div>
        ...
        <div className="hidden lg:block overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="text-left">
              <tr>
                <th className="px-6 py-3 text-gray-500 font-medium">Atualizado em</th>
                <th className="px-6 py-3 text-gray-500 font-medium">Id</th>
                <th className="px-6 py-3 text-gray-500 font-medium">Título e Serviço</th>
                <th className="px-6 py-3 text-gray-500 font-medium">Valor total</th>
                <th className="px-6 py-3 text-gray-500 font-medium">Cliente</th>
                <th className="px-6 py-3 text-gray-500 font-medium">Técnico</th>
                <th className="px-6 py-3 text-gray-500 font-medium">Status</th>
                <th className="px-6 py-3 text-gray-500 font-medium">Detalhes</th>
              </tr>
            </thead>
