...
export function TicketsDetails() {
  ...
  return (
    <div className="p-6 text-gray-800">
      <button
        onClick={() => navigate(-1)}
        className="text-sm text-gray-600 hover:text-blue-600 flex items-center mb-6"
      >
        ← Voltar
      </button>
      ...
      <div className="flex justify-between items-start mb-6">
        ...
        <div className="flex gap-3">
          <button className="px-4 py-2 rounded-lg border border-gray-300 text-gray-700 text-sm flex items-center gap-2">
